...
namespace BistroBoss.Areas.Identity.Pages.Account
{
    public class ConfirmEmailChangeModel : BasePageModel
    {
        ...
        public ConfirmEmailChangeModel(ApplicationDbContext dbContext, UserManager<Uzytkownik> userManager, SignInManager<Uzytkownik> signInManager) : base(dbContext)
        {
